...
import org.jibble.pircbot.PircBot.MessageQueueEntry;
...
public class Queue {
	 ...
	 */
	public CountDownLatch add(String o) {
		CountDownLatch latch = new CountDownLatch(1);
		synchronized (_queue) {
			_queue.addElement(new MessageQueueEntry(o, latch));
			_queue.notify();
		}
		return latch;
	}
	 ...
	 * @param o The Object to be added to the Queue.
	 */
	public CountDownLatch addFront(String o) {
		CountDownLatch latch = new CountDownLatch(1);
		synchronized (_queue) {
			_queue.insertElementAt(new MessageQueueEntry(o, latch), 0);
			_queue.notify();
		}
		return latch;
	}
